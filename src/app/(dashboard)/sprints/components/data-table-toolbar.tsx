...
import { sprintStatuses } from '@/lib/constants';
  ...
  return (
    <div className="flex items-center justify-between">
      <div className="flex flex-1 items-center space-x-2">
        ...
        />
        {table.getColumn('status') && <DataTableFacetedFilter column={table.getColumn('status')} title="Status" options={sprintStatuses} />}
        {isFiltered && (
